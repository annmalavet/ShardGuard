...
def _coerce_types(args: dict[str, Any], schema: dict[str, Any]) -> dict[str, Any]:
    """
    Best-effort type coercion using JSON schema info (mainly to turn "30" -> 30 when schema expects number).
    This only runs *after* placeholder resolution, before MCP tool execution.
    """
